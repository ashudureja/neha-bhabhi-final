...
const ExperienceCard = ({ exp, index }) => {
  ...
  return (
    <motion.div
      ...
      className="w-full  relative border border-gray-50 bg-gray-200 backdrop-blur-3xl rounded-xl  lg:rounded-4xl p-2 sm:p-3 shadow-[0_3px_10px_rgb(0,0,0,0.2)]"
    >
      <motion.div 
        className="relative bg-gradient-to-b from-transparent via-yellow-50 to-yellow-400 rounded-xl   overflow-hidden lg:rounded-3xl h-full sm:h-70 p-6 border border-[#e0e0eb] flex flex-col shadow-[0_4px_6px_-2px_rgb(151_151_185)]"
      >
       ...
       <SparklesCore
        ...
        <motion.div  
          ...
          <ul className="space-y-2 font-[para] text-[3.5cqw] md:text-[2.2vw] lg:text-xl 2xl:text-[22px] text-black">
